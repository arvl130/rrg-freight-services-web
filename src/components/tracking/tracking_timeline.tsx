...
import { Package, Truck, Path, MapPin } from '@phosphor-icons/react'

const TimelineItem = ({ icon, date, title, description }: { icon: React.ReactNode; date: string; title: string; description: string }) => {
  return (
