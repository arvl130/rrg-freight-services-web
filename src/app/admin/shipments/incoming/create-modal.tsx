    ...
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(calc(100%_-_3rem),_72rem)] h-[calc(100svh_-_2.5rem)] grid grid-rows-[auto_1fr] rounded-2xl bg-white"
        >
